...
void DrawWidget::drawShape(const QPointF ptStart,const QPointF ptEnd,const ST::ShapeType drawType)
{
   ...
   QPen pen;
    ...
    case ST::Diamond:{
        ...
        QPointF point22( ptStart.x(),(ptStart.y()+ptEnd.y())/2);
        QPointF point33( (ptStart.x()+ptEnd.x())/2,ptEnd.y());
        QPointF point44( ptEnd.x(),(ptStart.y()+ptEnd.y())/2);

        QVector<QPointF> pointss;
        pointss<<point11<<point22<<point33<<point44;
